...
};gdjs.Percurso_32CarmoCode.userFunc0x8669a8 = function(runtimeScene) {
"use strict";
...
gdjs.Percurso_32CarmoCode.userFunc0x866a50 = function(runtimeScene) {
"use strict";
...
{runtimeScene.getGame().getVariables().getFromIndex(2).setNumber(8);
    ...
    gdjs.Percurso_32CarmoCode.GDURLObjects1[i].setString("https://maps.app.goo.gl/HPo2DiQTYdTz4DtF8");
}
...
gdjs.Percurso_32CarmoCode.userFunc0x8669a8(runtimeScene);
...
gdjs.Percurso_32CarmoCode.userFunc0x866a50(runtimeScene);
