...
};gdjs.Percurso_32BicaCode.userFunc0xb2e3e8 = function(runtimeScene) {
"use strict";
...
gdjs.Percurso_32BicaCode.userFunc0xb2e490 = function(runtimeScene) {
"use strict";
...
{runtimeScene.getGame().getVariables().getFromIndex(2).setNumber(21);
    ...
    gdjs.Percurso_32BicaCode.GDnext_95sceneObjects1[i].setString("Bica Enigma");
}
...
gdjs.Percurso_32BicaCode.userFunc0xb2e3e8(runtimeScene);
...
gdjs.Percurso_32BicaCode.userFunc0xb2e490(runtimeScene);
