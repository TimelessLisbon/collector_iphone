...
};gdjs.Percurso_32S_46_32CarlosCode.userFunc0x867690 = function(runtimeScene) {
"use strict";
...
gdjs.Percurso_32S_46_32CarlosCode.userFunc0x867738 = function(runtimeScene) {
"use strict";
...
{runtimeScene.getGame().getVariables().getFromIndex(2).setNumber(27);
    ...
    gdjs.Percurso_32S_46_32CarlosCode.GDURLObjects1[i].setString("https://maps.app.goo.gl/RwUBj6ZTWreNx8Za8");
}
...
gdjs.Percurso_32S_46_32CarlosCode.userFunc0x867690(runtimeScene);
...
gdjs.Percurso_32S_46_32CarlosCode.userFunc0x867738(runtimeScene);
